export function NoteCard() {
  return (
    <button className="rounded-md text-left bg-slate-800 p-5 space-y-3 overflow-hidden hover:ring-2 hover:ring-slate-600 focus:ring-2 focus:ring-lime-400 outline-none relative">
